...
<div class="main">
	<div class="col-left channel-hot">
        ...
        <div class="icon"></div>
        	<div class="content">
        	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=cb9720b0d9eccd952e4678f7fa011f1f&action=position&posid=12&catid=%24catid&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'12','catid'=>$catid,'order'=>'listorder DESC','limit'=>'12',));}?>
