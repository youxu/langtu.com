...
<p class="cp">Powered by <strong><a href="http://www.grandcloud.cn/product/video" target="_blank">盛大视频云</a></strong> &copy; <?php echo date('Y', SYS_TIME);?> <img src="<?php echo IMG_PATH;?>copyright.gif"/>
</p>
</div>
</body>
</html>